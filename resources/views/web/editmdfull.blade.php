...
<head>
    ...
    <link rel="stylesheet" href="{{asset('editor.md/examples/css/style.css')}}" />
...
<script type="text/javascript">
    ...
    var singleTest = {
        _md: '{{asset('editor.md/examples/test.md')}}',//请求的test 目录
        _path: '{{asset('editor.md/lib')}}' + '/',//lib 目录
        _imageUploadURL: '{{route('web.uploader')}}',//图片上传路径
        _imageCallBack:'{{route('web.upcallback')}}',//图片上传回调
    };

    $(function() {

        $.get(singleTest._md, function(md){
            testEditor = editormd("test-editormd", {
                width: "90%",
                height: 740,
                path : singleTest._path,//'../lib/',
                theme : "dark",
                previewTheme : "dark",
                ...
                imageUploadURL : singleTest._imageUploadURL,//"./php/upload.php",
                crossDomainUpload : true,
                uploadCallbackURL: singleTest._imageCallBack,
                onload : function() {
//                    console.log('onload', this);
        ...
        $("#get-md-btn").bind('click', function(){
            var get_md = testEditor.getMarkdown();
            alert(get_md);
        });
